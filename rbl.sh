...
# host 130.176.12.203.b.barracudacentral.org
...
NAMESERVERS=( $( dig +short ns "b.barracudacentral.org." ) ) # 192.168.1.1 203.12.176.130 61.9.197.116 8.8.8.8 61.9.211.1 )
cat spam_check.ips | 
while read -r 
do
	explode "." "$REPLY"
	rhost="${EXPLODED[3]}.${EXPLODED[2]}.${EXPLODED[1]}.${EXPLODED[0]}.b.barracudacentral.org"
